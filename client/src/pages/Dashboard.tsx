...
export default function Dashboard() {
  ...
  return (
    ...
    >
      ...
      <h2 className="text-xl font-display font-bold text-slate-900 mb-6">Latest Vitals</h2>
      ...
      {latest ? (
        ...
        <div className="bg-slate-50 border border-dashed border-slate-300 rounded-2xl p-12 text-center">
          ...
          <p className="text-slate-500 max-w-sm mx-auto mb-6">Start tracking your health journey by logging your first measurement.</p>
        </div>
      )}
      ...
      <div className="mt-12">
         <div className="flex items-center justify-between mb-6">
            <h2 className="text-xl font-display font-bold text-slate-900">Recent History</h2>
              ...
              <div className="p-6 hover:bg-slate-50 transition-colors">
                 <div className="grid grid-cols-3 sm:grid-cols-4 gap-4 items-center text-sm">
                    ...
                    <div className="text-slate-600">
                      {weight?.value ?? '-'} <span className="text-xs text-slate-400">{weight?.unit}</span>
                    </div>
                    <div className="hidden sm:block text-slate-600">
                      {bodyFat?.value ?? '-'} <span className="text-xs text-slate-400">{bodyFat?.unit}</span>
                    </div>
